...
public class Parking {
    ...
    @Column(name = "free_parking_spots")
    ...
    public Parking(Long id, String direction, int bikesCapacity, float latitude, float longitude,
                   int bikesAvailable, int freeParkingSpots, Instant createdAt) {
        this.id = id;
